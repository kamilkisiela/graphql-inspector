---
description: GraphQL Inspector App is a GitHub Application that you can install in any of your repositories.
---
...
<Callout>
  Under the hood, the GraphQL Inspector uses [Probot](https://probot.github.io),
  a bot made by the GitHub team.
</Callout>
