---
title:
  GraphQL Inspector | Compare GraphQL Schemas, Validate Documents, Find Breaking Changes, Schema
  Coverage
description:
...
- [**GitHub Action**](/docs/products/action) ![App and Action](/assets/img/github/app-action.jpg)
