...
1. Visit [GraphQL Inspector](https://github.com/marketplace/graphql-inspector) on GitHub
   Marketplace.
2. Follow the installation instructions provided in the ["GitHub Application"](../products/github)
   chapter.
