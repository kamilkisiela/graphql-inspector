...
<Callout>
  GraphQL Inspector GitHub Application is open-sourced, we host it so you don't
  have to.
</Callout>
...
<Callout>
  GraphQL Inspector has a **CLI** and also a **programmatic API**, so you can
  use it however you want to and even build tools on top of it.
</Callout>
