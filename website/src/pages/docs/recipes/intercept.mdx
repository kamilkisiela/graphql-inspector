...
Configuring an interceptor looks fairly similar to [`endpoints`](endpoints), except you can't modify a method, it's always POST request.
...
Let's set all [criticality levels to Non-Breaking](https://github.com/kamilkisiela/graphql-inspector/blob/master/packages/core/src/diff/changes/change.ts#L67) and GitHub Check [conclusion to Success](https://github.com/kamilkisiela/graphql-inspector/blob/master/packages/github/src/types.ts#L33).
