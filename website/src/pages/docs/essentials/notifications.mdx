...
To reduce the noise, you can set up Slack notifications only for the Production environment.
...
To use Slack notifications, you need to create your application on Slack and an Incoming Webhook. <span style={{textDecoration: 'underline'}}>[Follow these instructions](https://slack.com/intl/en-pl/help/articles/115005265063-Incoming-Webhooks-for-Slack)</span>.
