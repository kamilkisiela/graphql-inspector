...
const mockUpdateCheckRun = updateCheckRun as vi.MockedFunction<
  typeof updateCheckRun
>;
const mockFileLoader = fileLoader as vi.MockedFunction<typeof fileLoader>;
const mockGetAssociatedPullRequest =
  getAssociatedPullRequest as vi.MockedFunction<
        ...
        output: {
          ...
          annotations: [
            ...
            },
            {
              ...
              start_line: 2,
              title:
                "Field 'oldQuery' (deprecated) was removed from object type 'Query'",
            },
          ],
        },
      });
