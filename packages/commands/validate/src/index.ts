...
>((api) => {
  ...
  return {
    ...
    async handler(args) {
      ...
      const maxAliasCount =
        args.maxAliasCount == null ? undefined : args.maxAliasCount;
      const maxDirectiveCount =
        args.maxDirectiveCount == null ? undefined : args.maxDirectiveCount;
      const maxTokenCount =
        args.maxTokenCount == null ? undefined : args.maxTokenCount;
